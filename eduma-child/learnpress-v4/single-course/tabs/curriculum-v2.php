...
if ( empty( $sections ) || empty( $course_id ) || empty( $filters ) ) {
	return;
}

?>
<h3 class="title-custom-single-course-temario">Temario del curso</h3>
<div class="course-curriculum" id="learn-press-course-curriculum">
	...
	<?php if ( $sections['pages'] > 1 && $sections['pages'] > $filters->page ) : ?>
		<div class="curriculum-more">
			<span class="curriculum-more__button" data-page="<?php echo esc_attr( $filters->page ); ?>">
